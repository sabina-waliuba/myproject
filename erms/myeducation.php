...
<tr>
  <th>Year of Passing Graduate School</th>
  <td><?php echo $row['YearPassingGra'];?></td>
</tr>
<tr>
  <th>GPA in Bachelors</th>
  <td><?php echo $row['PercentageGra'];?></td>
</tr>
<th>Bachelors Course Name</th>
  <td><?php echo $row['CourseSSC'];?></td>
</tr>
<tr>
  <th>Bachelors School/College</th>
  <td><?php echo $row['SchoolCollegeSSC'];?></td>
</tr>
<tr>
  <th>Year of Passing Diploma</th>
  <td><?php echo $row['YearPassingSSC'];?></td>
</tr>
<tr>
  <th>GPA in Diploma</th>
...
<tr>
  <th>Diploma School/College</th>
  <td><?php echo $row['SchoolCollegeHSC'];?></td>
</tr>
<tr>
  <th>Year of Passing in Certificate education</th>
  <td><?php echo $row['YearPassingHSC'];?></td>
</tr>
<tr>
  <th>GPA in Certificate</th>
...
<form class="user" method="post" action="">
               ...
               <div class="row">
                <div class="col-4 mb-3">Post Graduate Course Name</div>
                ...
                <div class="col-4 mb-3">Graduate Course Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="coursegra" name="coursegra" aria-describedby="emailHelp" value="" required="true"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Graduate School/College</div>
                    ...
                    <div class="row">
                    <div class="col-4 mb-3">Year of Passing Graduate School </div>
                    <div class="col-8 mb-3">
                ...
                <div class="col-4 mb-3">Bachelors Course Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="coursessc" name="coursessc" aria-describedby="emailHelp" value="" required="true"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Bachelors School/College</div>
                    ...
                    <div class="row">
                    <div class="col-4 mb-3">Year of Passing Diploma </div>
                    <div class="col-8 mb-3">
                ...
                <div class="col-4 mb-3">Diploma Course Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="coursehsc" name="coursehsc" aria-describedby="emailHelp" value="" required="true"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Diploma School/College</div>
                    ...
                    <div class="row">
                    <div class="col-4 mb-3">Year of Passing Certificate Education </div>
                    <div class="col-8 mb-3">
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">GPA in Certificate Education</div>
                     <div class="col-8 mb-3">
